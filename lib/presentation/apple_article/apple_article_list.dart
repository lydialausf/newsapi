...
class AppleArticleList extends StatefulWidget {
  const AppleArticleList({super.key});

  @override
  State<AppleArticleList> createState() => _AppleArticleListState();
}

class _AppleArticleListState extends State<AppleArticleList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Apple Article'),
        ),
        body: FutureBuilder<List<ArticleResponse>>(
            future: NewsController().fetchApple(),
